...
First, we will test that the singular pole works as intended.
...
\end{equation}
where $\Da$ is the Dawson function. % Have some sort of discusison of this in the numerical methods section and reference it here
